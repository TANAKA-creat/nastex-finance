  ...
  @section('content')
      <div class="container">
          <div class="row">
              ...
              <h1>副資材支払 - 詳細</h1>
              <div class="back-link">
                  <a href="{{ route('auxiliary_material_credits.show') }}">&laquo; 時間指定に移動</a>
              ...
              <div class="col-md-6">
                  <div class="test">
                      <form action="{{ route('auxiliary_material_credits.name') }}" method="POST">
                          @csrf
                          <div class="form-group">
                              <input type="text" name="auxiliary_material_credit_creditor" placeholder="項目名">
                  ...
                  <table border="2" class="table" style="solid 2px";>
                      <thead>
                          <tr>
                            ...
                            <th>@sortablelink('auxiliary_material_credit_creditor','支払項目')</th>
