                  ...
                  <tbody>
                    ...
                    <td class="list">
                      <?php $no_receipt_deposits_total1 = $no_receipt_deposits
                              ...
                              ->whereBetween('datetime_no_receipt_deposit', ['2022-01-01', '2022-01-31'])
                    ...
                    <td class="list">
                        <?php 
                            ...
                            ->where('no_receipt_deposit_customer_id', '=', '1')
                            ->whereBetween('datetime_no_receipt_deposit', ['2022-02-01', '2022-02-28'])
                            ->sum('rmb_no_receipt_deposit') +
                             $no_receipt_deposits_total = $no_receipt_deposits
                            ->where('no_receipt_deposit_customer_id', '=', '2')
                            ->whereBetween('datetime_no_receipt_deposit', ['2022-02-01', '2022-02-28'])
                    ...
                    <td class="list">
                        <?php 
                            ...
                            ->where('no_receipt_deposit_customer_id', '=', '1')
                            ->whereBetween('datetime_no_receipt_deposit', ['2022-03-01', '2022-03-31'])
                            ->sum('rmb_no_receipt_deposit') +
                            $no_receipt_deposits_total = $no_receipt_deposits
                            ->where('no_receipt_deposit_customer_id', '=', '2')
                            ->whereBetween('datetime_no_receipt_deposit', ['2022-03-01', '2022-03-31'])
                    ...
                    <td class="list">
                        ...
                        $no_receipt_deposits_total4 = $no_receipt_deposits
                            ->where('no_receipt_deposit_customer_id', '=', '1')
                            ->whereBetween('datetime_no_receipt_deposit', ['2022-04-01', '2022-04-30'])
                            ->sum('rmb_no_receipt_deposit') +
                            $no_receipt_deposits_total = $no_receipt_deposits
                            ->where('no_receipt_deposit_customer_id', '=', '2')
                            ->whereBetween('datetime_no_receipt_deposit', ['2022-04-01', '2022-04-30'])
                    ...
                    <td class="list">
                        ...
                        $no_receipt_deposits_total5 = $no_receipt_deposits
                            ->where('no_receipt_deposit_customer_id', '=', '1')
                            ->whereBetween('datetime_no_receipt_deposit', ['2022-05-01', '2022-05-31'])
                            ->sum('rmb_no_receipt_deposit') +
                            $no_receipt_deposits_total = $no_receipt_deposits
                            ->where('no_receipt_deposit_customer_id', '=', '2')
                            ->whereBetween('datetime_no_receipt_deposit', ['2022-05-01', '2022-05-31'])
                    ...
                    <td class="list">
                        ...
                        $no_receipt_deposits_total6 = $no_receipt_deposits
                            ->where('no_receipt_deposit_customer_id', '=', '1')
                            ->whereBetween('datetime_no_receipt_deposit', ['2022-06-01', '2022-06-30'])
                            ->sum('rmb_no_receipt_deposit') +
                            $no_receipt_deposits_total = $no_receipt_deposits
                            ->where('no_receipt_deposit_customer_id', '=', '2')
                            ->whereBetween('datetime_no_receipt_deposit', ['2022-06-01', '2022-06-30'])
                    ...
                    <td class="list">
                        ...
                        $no_receipt_deposits_total7 = $no_receipt_deposits
                            ->where('no_receipt_deposit_customer_id', '=', '1')
                            ->whereBetween('datetime_no_receipt_deposit', ['2022-07-01', '2022-07-31'])
                            ->sum('rmb_no_receipt_deposit') +
                            $no_receipt_deposits_total = $no_receipt_deposits
                            ->where('no_receipt_deposit_customer_id', '=', '2')
                            ->whereBetween('datetime_no_receipt_deposit', ['2022-07-01', '2022-07-31'])
                    ...
                    <td class="list">
                        ...
                        $no_receipt_deposits_total8 = $no_receipt_deposits
                            ->where('no_receipt_deposit_customer_id', '=', '1')
                            ->whereBetween('datetime_no_receipt_deposit', ['2022-08-01', '2022-08-31'])
                            ->sum('rmb_no_receipt_deposit') +
                            $no_receipt_deposits_total = $no_receipt_deposits
                            ->where('no_receipt_deposit_customer_id', '=', '2')
                            ->whereBetween('datetime_no_receipt_deposit', ['2022-08-01', '2022-08-31'])
                    ...
                    <td class="list">
                        ...
                        $no_receipt_deposits_total9 = $no_receipt_deposits
                            ->where('no_receipt_deposit_customer_id', '=', '1')
                            ->whereBetween('datetime_no_receipt_deposit', ['2022-09-01', '2022-09-30'])
                            ->sum('rmb_no_receipt_deposit') +
                            $no_receipt_deposits_total = $no_receipt_deposits
                            ->where('no_receipt_deposit_customer_id', '=', '2')
                            ->whereBetween('datetime_no_receipt_deposit', ['2022-09-01', '2022-09-30'])
                    ...
                    <td class="list">
                        ...
                        $no_receipt_deposits_total10 = $no_receipt_deposits
                            ->where('no_receipt_deposit_customer_id', '=', '1')
                            ->whereBetween('datetime_no_receipt_deposit', ['2022-10-01', '2022-10-31'])
                            ->sum('rmb_no_receipt_deposit') +
                            $no_receipt_deposits_total = $no_receipt_deposits
                            ->where('no_receipt_deposit_customer_id', '=', '2')
                            ->whereBetween('datetime_no_receipt_deposit', ['2022-10-01', '2022-10-31'])
                    ...
                    <td class="list">
                        ...
                        $no_receipt_deposits_total11 = $no_receipt_deposits
                            ->where('no_receipt_deposit_customer_id', '=', '1')
                            ->whereBetween('datetime_no_receipt_deposit', ['2022-11-01', '2022-11-30'])
                            ->sum('rmb_no_receipt_deposit') +
                            $no_receipt_deposits_total = $no_receipt_deposits
                            ->where('no_receipt_deposit_customer_id', '=', '2')
                            ->whereBetween('datetime_no_receipt_deposit', ['2022-11-01', '2022-11-30'])
                    ...
                    <td class="list">
                        ...
                        $no_receipt_deposits_total12 = $no_receipt_deposits
                            ->where('no_receipt_deposit_customer_id', '=', '1')
                            ->whereBetween('datetime_no_receipt_deposit', ['2022-12-01', '2022-12-31'])
                            ->sum('rmb_no_receipt_deposit') +
                            $no_receipt_deposits_total = $no_receipt_deposits
                            ->where('no_receipt_deposit_customer_id', '=', '2')
                            ->whereBetween('datetime_no_receipt_deposit', ['2022-12-01', '2022-12-31'])
