...
@section('content') --}}
    <div class="container profit-and-loss-container">{{-- 表の全体をdivで囲む --}}
        <div class="row">
            ...
            <div class="totalamount-no-receipt2022" id="totalamout-no-receipt2022">
...
{{-- 2023年度 --------------------------------------------------------------------------------------------------}}
    <div class="totalamount-no-receipt2023" id="totalamout-no-receipt2023">
        <div  class="recording-period">
        <h3>損益計算書（領収書有りのみ）</h3>
        ...
        <table>
            ...
            <tr>
                ...
                <td class="list">
                    <?php $details_total = $details->whereBetween('datetime', ['2023-02-01', '2023-02-29'])->sum('rmb'); ?>
                    <?php echo number_format($details_total, 2); ?>
                </td>
                <td class="list">
                ...
                <td class="list">
                    ...
                    + $details->whereBetween('datetime', ['2023-02-01', '2023-02-29'])->sum('rmb')
            ...
            <tr>
                ...
                <td class="list">
                    <?php $other_country_deposits_total = $other_country_deposits->whereBetween('datetime_other_country_deposit', ['2023-02-01', '2023-02-29'])->sum('rmb_other_country_deposit'); ?>
                    <?php echo number_format($other_country_deposits_total,2); ?>
                </td>
                <td class="list">
                ...
                <td class="list">
                    ...
                    + $other_country_deposits->whereBetween('datetime_other_country_deposit', ['2023-02-01', '2023-02-29'])->sum('rmb_other_country_deposit')
            ...
            <tr>
                ...
                <td class="list">
                    <?php $within_china_deposits_total = $within_china_deposits->whereBetween('datetime_within_china_deposit', ['2023-02-01', '2023-02-29'])->sum('rmb_within_china_deposit'); ?>
                    <?php echo number_format($within_china_deposits_total,2); ?>
                </td>
                <td class="list">
                ...
                <td class="list">
                    ...
                    + $within_china_deposits->whereBetween('datetime_within_china_deposit', ['2023-02-01', '2023-02-29'])->sum('rmb_within_china_deposit')
            ...
            <tr>
                ...
                <td class="list">
                    <?php $hongkong_deposits_total = $hongkong_deposits->whereBetween('datetime_hongkong_deposit', ['2023-02-01', '2023-02-29'])->sum('rmb_hongkong_deposit'); ?>
                    <?php echo number_format($hongkong_deposits_total,2); ?>
                </td>
                <td class="list">
                ...
                <td class="list">
                    ...
                    + $hongkong_deposits->whereBetween('datetime_hongkong_deposit', ['2023-02-01', '2023-02-29'])->sum('rmb_hongkong_deposit')
            ...
            <tr>
                ...
                <td class="list">
                    <?php $outsourcing_deposits_total = $outsourcing_deposits->whereBetween('datetime_outsourcing_deposit', ['2023-02-01', '2023-02-29'])->sum('rmb_outsourcing_deposit'); ?>
                    <?php echo number_format($outsourcing_deposits_total,2); ?>
                </td>
                <td class="list">
                ...
                <td class="list">
                    ...
                    + $outsourcing_deposits->whereBetween('datetime_outsourcing_deposit', ['2023-02-01', '2023-02-29'])->sum('rmb_outsourcing_deposit')
            ...
            <tr>
                ...
                <td class="list">
                    <?php $other_deposits_total = $other_deposits->whereBetween('datetime_other_deposit', ['2023-02-01', '2023-02-29'])->sum('rmb_other_deposit'); ?>
                    <?php echo number_format($other_deposits_total,2); ?>
                </td>
                <td class="list">
                ...
                <td class="list">
                    ...
                    + $other_deposits->whereBetween('datetime_other_deposit', ['2023-02-01', '2023-02-29'])->sum('rmb_other_deposit')
            ...
            <tr>
                ...
                <td class="list">
                    <?php $material_credits_total = $material_credits->whereBetween('datetime_material_credit', ['2023-02-01', '2023-02-29'])->sum('rmb_material_credit'); ?>
                    <?php echo number_format($material_credits_total,2); ?>
                </td>
                <td class="list">
            ...
            <tr>
                ...
                <td class="list">
                    <?php $auxiliary_material_credits_total = $auxiliary_material_credits->whereBetween('datetime_auxiliary_material_credit', ['2023-02-01', '2023-02-29'])->sum('rmb_auxiliary_material_credit'); ?>
                    <?php echo number_format($auxiliary_material_credits_total,2); ?>
                </td>
                <td class="list">
                ...
                <td class="list">
                    ...
                    + $auxiliary_material_credits->whereBetween('datetime_auxiliary_material_credit', ['2023-02-01', '2023-02-29'])->sum('rmb_auxiliary_material_credit')
            ...
            <tr>
                ...
                <td class="list-twin">
                    <?php $w2 = $details->whereBetween('datetime', ['2023-02-01', '2023-02-29'])->sum('rmb') 
                    + $other_country_deposits->whereBetween('datetime_other_country_deposit', ['2023-02-01', '2023-02-29'])->sum('rmb_other_country_deposit') 
                    + $within_china_deposits->whereBetween('datetime_within_china_deposit', ['2023-02-01', '2023-02-29'])->sum('rmb_within_china_deposit') 
                    // + $no_receipt_deposits->whereBetween('datetime_no_receipt_deposit', ['2023-02-01', '2023-02-29'])->sum('rmb_no_receipt_deposit') 
                    + $hongkong_deposits->whereBetween('datetime_hongkong_deposit', ['2023-02-01', '2023-02-29'])->sum('rmb_hongkong_deposit')
                    + $outsourcing_deposits->whereBetween('datetime_outsourcing_deposit', ['2023-02-01', '2023-02-29'])->sum('rmb_outsourcing_deposit')
                    + $other_deposits->whereBetween('datetime_other_deposit', ['2023-02-01', '2023-02-29'])->sum('rmb_other_deposit')
                    // + $no_receipt_other_deposits->whereBetween('datetime_no_receipt_other_deposit', ['2023-02-01', '2023-02-29'])->sum('rmb_no_receipt_other_deposit')
                    - $material_credits->whereBetween('datetime_material_credit', ['2023-02-01', '2023-02-29'])->sum('rmb_material_credit')
                    - $auxiliary_material_credits->whereBetween('datetime_auxiliary_material_credit', ['2023-02-01', '2023-02-29'])->sum('rmb_auxiliary_material_credit')
                    ; ?>
                    <?php echo number_format($w2,2); ?>
                </td>
            ...
            <tr>
                ...
                <td class="list">
                    <?php $salary_credits_total = $salary_credits->whereBetween('datetime_salary_credit', ['2023-02-01', '2023-02-29'])->sum('rmb_salary_credit'); ?>
                    <?php echo number_format($salary_credits_total,2); ?>
                </td>
                <td class="list">
                ...
                <td class="list">
                    ...
                    + $salary_credits->whereBetween('datetime_salary_credit', ['2023-02-01', '2023-02-29'])->sum('rmb_salary_credit')
            ...
            <tr>
                ...
                <td class="list">
                    <?php $insurances_total = $insurances->whereBetween('datetime_insurance', ['2023-02-01', '2023-02-29'])->sum('rmb_insurance'); ?>
                    <?php echo number_format($insurances_total,2); ?>
                </td>
                <td class="list">
                ...
                <td class="list">
                    ...
                    + $insurances->whereBetween('datetime_insurance', ['2023-02-01', '2023-02-29'])->sum('rmb_insurance')
            ...
            <tr>
                ...
                <td class="list">
                    <?php $ticket_fees_total = $ticket_fees->whereBetween('datetime_ticket_fee', ['2023-02-01', '2023-02-29'])->sum('rmb_ticket_fee'); ?>
                    <?php echo number_format($ticket_fees_total,2); ?>
                </td>
                <td class="list">
                ...
                <td class="list">
                    ...
                    + $ticket_fees->whereBetween('datetime_ticket_fee', ['2023-02-01', '2023-02-29'])->sum('rmb_ticket_fee')
            ...
            <tr>
                ...
                <td class="list">
                    <?php $travel_expenses_total = $travel_expenses->whereBetween('datetime_travel_expense', ['2023-02-01', '2023-02-29'])->sum('rmb_travel_expense'); ?>
                    <?php echo number_format($travel_expenses_total,2); ?>
                </td>
                <td class="list">
                ...
                <td class="list">
                    ...
                    + $travel_expenses->whereBetween('datetime_travel_expense', ['2023-02-01', '2023-02-29'])->sum('rmb_travel_expense')
            ...
            <tr>
                ...
                <td class="list">
                    <?php $utility_costs_total = $utility_costs->whereBetween('datetime_utility_cost', ['2023-02-01', '2023-02-29'])->sum('rmb_utility_cost'); ?>
                    <?php echo number_format($utility_costs_total,2); ?>
                </td>
                <td class="list">
                ...
                <td class="list">
                    ...
                    + $utility_costs->whereBetween('datetime_utility_cost', ['2023-02-01', '2023-02-29'])->sum('rmb_utility_cost')
            ...
            <tr>
                ...
                <td class="list">
                    <?php $tax_credits_total = $tax_credits->whereBetween('datetime_tax_credit', ['2023-02-01', '2023-02-29'])->sum('rmb_tax_credit'); ?>
                    <?php echo number_format($tax_credits_total,2); ?>
                </td>
                <td class="list">
                ...
                <td class="list">
                    ...
                    + $tax_credits->whereBetween('datetime_tax_credit', ['2023-02-01', '2023-02-29'])->sum('rmb_tax_credit')
            ...
            <tr>
                ...
                <td class="list">
                    <?php $miscellaneous_expenses_total = $miscellaneous_expenses->whereBetween('datetime_miscellaneous_expense', ['2023-02-01', '2023-02-29'])->sum('rmb_miscellaneous_expense'); ?>
                    <?php echo number_format($miscellaneous_expenses_total,2); ?>
                </td>
                <td class="list">
                ...
                <td class="list">
                    ...
                    + $miscellaneous_expenses->whereBetween('datetime_miscellaneous_expense', ['2023-02-01', '2023-02-29'])->sum('rmb_miscellaneous_expense')
            ...
            <tr>
                ...
                <td class="list">
                    <?php $entertainment_expenses_total = $entertainment_expenses->whereBetween('datetime_entertainment_expense', ['2023-02-01', '2023-02-29'])->sum('rmb_entertainment_expense'); ?>
                    <?php echo number_format($entertainment_expenses_total,2); ?>
                </td>
                <td class="list">
                ...
                <td class="list">
                    ...
                    + $entertainment_expenses->whereBetween('datetime_entertainment_expense', ['2023-02-01', '2023-02-29'])->sum('rmb_entertainment_expense')
            ...
            <tr>
                ...
                <td class="list">
                    <?php $logistics_costs_total = $logistics_costs->whereBetween('datetime_logistics_cost', ['2023-02-01', '2023-02-29'])->sum('rmb_logistics_cost'); ?>
                    <?php echo number_format($logistics_costs_total,2); ?>
                </td>
                <td class="list">
                ...
                <td class="list">
                    ...
                    + $logistics_costs->whereBetween('datetime_logistics_cost', ['2023-02-01', '2023-02-29'])->sum('rmb_logistics_cost')
            ...
            <tr>
                ...
                <td class="list">
                    <?php $others_total = $others->whereBetween('datetime_other', ['2023-02-01', '2023-02-29'])->sum('rmb_other'); ?>
                    <?php echo number_format($others_total,2); ?>
                </td>
                <td class="list">
                ...
                <td class="list">
                    ...
                    + $others->whereBetween('datetime_other', ['2023-02-01', '2023-02-29'])->sum('rmb_other')
            ...
            <tr>
                ...
                <td class="list-twin">
                    <?php $x2 = $details->whereBetween('datetime', ['2023-02-01', '2023-02-29'])->sum('rmb') 
                    + $other_country_deposits->whereBetween('datetime_other_country_deposit', ['2023-02-01', '2023-02-29'])->sum('rmb_other_country_deposit') 
                    + $within_china_deposits->whereBetween('datetime_within_china_deposit', ['2023-02-01', '2023-02-29'])->sum('rmb_within_china_deposit') 
                    // + $no_receipt_deposits->whereBetween('datetime_no_receipt_deposit', ['2023-02-01', '2023-02-29'])->sum('rmb_no_receipt_deposit') 
                    + $hongkong_deposits->whereBetween('datetime_hongkong_deposit', ['2023-02-01', '2023-02-29'])->sum('rmb_hongkong_deposit')
                    ...
                    - $logistics_costs->whereBetween('datetime_logistics_cost', ['2023-02-01', '2023-02-29'])->sum('rmb_logistics_cost')
                    - $others->whereBetween('datetime_other', ['2023-02-01', '2023-02-29'])->sum('rmb_other')
                    // - $no_receipt_credits->whereBetween('datetime_no_receipt_credit', ['2023-02-01', '2023-02-29'])->sum('rmb_no_receipt_credit')
                    ; ?>
                    <?php echo number_format($x2,2); ?>
                </td>
                <td class="list-twin">
...
{{-- 2024年度 --------------------------------------------------------------------------------------------------}}
<div class="totalamount-no-receipt2024" id="totalamout-no-receipt2024">
    <div  class="recording-period">
    <h3>損益計算書（領収書有りのみ）</h3>
    ...
    <table>
        ...
        <tr>
            ...
            <th class="th"></th>
            <td class="list">
                <?php $within_china_deposits_total = $within_china_deposits->whereBetween('datetime_within_china_deposit', ['202420242024-01-01', '202420242024-01-31'])->sum('rmb_within_china_deposit'); ?>
                <?php echo number_format($within_china_deposits_total,2); ?>
            </td>
            <td class="list">
                <?php $within_china_deposits_total = $within_china_deposits->whereBetween('datetime_within_china_deposit', ['202420242024-02-01', '202420242024-02-29'])->sum('rmb_within_china_deposit'); ?>
                <?php echo number_format($within_china_deposits_total,2); ?>
            </td>
            <td class="list">
                <?php $within_china_deposits_total = $within_china_deposits->whereBetween('datetime_within_china_deposit', ['202420242024-03-01', '202420242024-03-31'])->sum('rmb_within_china_deposit'); ?>
                <?php echo number_format($within_china_deposits_total,2); ?>
            </td>
            <td class="list">
                <?php $within_china_deposits_total = $within_china_deposits->whereBetween('datetime_within_china_deposit', ['202420242024-04-01', '202420242024-04-30'])->sum('rmb_within_china_deposit'); ?>
                <?php echo number_format($within_china_deposits_total,2); ?>
            </td>
            <td class="list">
                <?php $within_china_deposits_total = $within_china_deposits->whereBetween('datetime_within_china_deposit', ['20242024-05-01', '20242024-05-31'])->sum('rmb_within_china_deposit'); ?>
                <?php echo number_format($within_china_deposits_total,2); ?>
            </td>
            <td class="list">
                <?php $within_china_deposits_total = $within_china_deposits->whereBetween('datetime_within_china_deposit', ['20242024-06-01', '20242024-06-30'])->sum('rmb_within_china_deposit'); ?>
                <?php echo number_format($within_china_deposits_total,2); ?>
            </td>
            <td class="list">
                <?php $within_china_deposits_total = $within_china_deposits->whereBetween('datetime_within_china_deposit', ['20242024-07-01', '20242024-07-31'])->sum('rmb_within_china_deposit'); ?>
                <?php echo number_format($within_china_deposits_total,2); ?>
            </td>
            <td class="list">
                <?php $within_china_deposits_total = $within_china_deposits->whereBetween('datetime_within_china_deposit', ['20242024-08-01', '20242024-08-31'])->sum('rmb_within_china_deposit'); ?>
                <?php echo number_format($within_china_deposits_total,2); ?>
            </td>
            <td class="list">
                <?php $within_china_deposits_total = $within_china_deposits->whereBetween('datetime_within_china_deposit', ['20242024-09-01', '20242024-09-30'])->sum('rmb_within_china_deposit'); ?>
                <?php echo number_format($within_china_deposits_total,2); ?>
            </td>
            <td class="list">
            ...
            <td class="list">
                ...
                + $within_china_deposits->whereBetween('datetime_within_china_deposit', ['20242024-06-01', '20242024-06-30'])->sum('rmb_within_china_deposit')
                + $within_china_deposits->whereBetween('datetime_within_china_deposit', ['20242024-07-01', '20242024-07-31'])->sum('rmb_within_china_deposit')
                + $within_china_deposits->whereBetween('datetime_within_china_deposit', ['20242024-08-01', '20242024-08-31'])->sum('rmb_within_china_deposit')
                + $within_china_deposits->whereBetween('datetime_within_china_deposit', ['20242024-09-01', '20242024-09-30'])->sum('rmb_within_china_deposit')
                + $within_china_deposits->whereBetween('datetime_within_china_deposit', ['20242024-10-01', '20242024-10-31'])->sum('rmb_within_china_deposit')
                + $within_china_deposits->whereBetween('datetime_within_china_deposit', ['20242024-11-01', '20242024-11-30'])->sum('rmb_within_china_deposit')
                + $within_china_deposits->whereBetween('datetime_within_china_deposit', ['20242024-12-01', '20242024-12-31'])->sum('rmb_within_china_deposit')
                ;?>
                <?php echo number_format($within_china_deposits_total_all,2) ; ?>
            </td>
            <td class="list">
        ...
        <tr>
            ...
            <td class="list">
                <?php $hongkong_deposits_total = $hongkong_deposits->whereBetween('datetime_hongkong_deposit', ['20242024-06-01', '20242024-06-30'])->sum('rmb_hongkong_deposit'); ?>
                <?php echo number_format($hongkong_deposits_total,2); ?>
            </td>
            <td class="list">
                <?php $hongkong_deposits_total = $hongkong_deposits->whereBetween('datetime_hongkong_deposit', ['20242024-07-01', '20242024-07-31'])->sum('rmb_hongkong_deposit'); ?>
                <?php echo number_format($hongkong_deposits_total,2); ?>
            </td>
            <td class="list">
                <?php $hongkong_deposits_total = $hongkong_deposits->whereBetween('datetime_hongkong_deposit', ['20242024-08-01', '20242024-08-31'])->sum('rmb_hongkong_deposit'); ?>
                <?php echo number_format($hongkong_deposits_total,2); ?>
            </td>
            <td class="list">
                <?php $hongkong_deposits_total = $hongkong_deposits->whereBetween('datetime_hongkong_deposit', ['20242024-09-01', '20242024-09-30'])->sum('rmb_hongkong_deposit'); ?>
                <?php echo number_format($hongkong_deposits_total,2); ?>
            </td>
            <td class="list">
                <?php $hongkong_deposits_total = $hongkong_deposits->whereBetween('datetime_hongkong_deposit', ['20242024-10-01', '20242024-10-31'])->sum('rmb_hongkong_deposit'); ?>
                <?php echo number_format($hongkong_deposits_total,2); ?>
            </td>
            <td class="list">
        ...
        <tr>
            ...
            <th class="th"></th>
            <td class="list">
                <?php $other_deposits_total = $other_deposits->whereBetween('datetime_other_deposit', ['2024202420242024-01-01', '2024202420242024-01-31'])->sum('rmb_other_deposit'); ?>
                <?php echo number_format($other_deposits_total,2); ?>
            </td>
            <td class="list">
                <?php $other_deposits_total = $other_deposits->whereBetween('datetime_other_deposit', ['2024202420242024-02-01', '2024202420242024-02-29'])->sum('rmb_other_deposit'); ?>
                <?php echo number_format($other_deposits_total,2); ?>
            </td>
            <td class="list">
                <?php $other_deposits_total = $other_deposits->whereBetween('datetime_other_deposit', ['2024202420242024-03-01', '2024202420242024-03-31'])->sum('rmb_other_deposit'); ?>
                <?php echo number_format($other_deposits_total,2); ?>
            </td>
            <td class="list">
                <?php $other_deposits_total = $other_deposits->whereBetween('datetime_other_deposit', ['2024202420242024-04-01', '2024202420242024-04-30'])->sum('rmb_other_deposit'); ?>
                <?php echo number_format($other_deposits_total,2); ?>
            </td>
            <td class="list">
                <?php $other_deposits_total = $other_deposits->whereBetween('datetime_other_deposit', ['2024202420242024-05-01', '2024202420242024-05-31'])->sum('rmb_other_deposit'); ?>
                <?php echo number_format($other_deposits_total,2); ?>
            </td>
            <td class="list">
                <?php $other_deposits_total = $other_deposits->whereBetween('datetime_other_deposit', ['202420242024-06-01', '202420242024-06-30'])->sum('rmb_other_deposit'); ?>
                <?php echo number_format($other_deposits_total,2); ?>
            </td>
            <td class="list">
                <?php $other_deposits_total = $other_deposits->whereBetween('datetime_other_deposit', ['202420242024-07-01', '202420242024-07-31'])->sum('rmb_other_deposit'); ?>
                <?php echo number_format($other_deposits_total,2); ?>
            </td>
            <td class="list">
                <?php $other_deposits_total = $other_deposits->whereBetween('datetime_other_deposit', ['202420242024-08-01', '202420242024-08-31'])->sum('rmb_other_deposit'); ?>
                <?php echo number_format($other_deposits_total,2); ?>
            </td>
            <td class="list">
                <?php $other_deposits_total = $other_deposits->whereBetween('datetime_other_deposit', ['202420242024-09-01', '202420242024-09-30'])->sum('rmb_other_deposit'); ?>
                <?php echo number_format($other_deposits_total,2); ?>
            </td>
            <td class="list">
                <?php $other_deposits_total = $other_deposits->whereBetween('datetime_other_deposit', ['202420242024-10-01', '202420242024-10-31'])->sum('rmb_other_deposit'); ?>
                <?php echo number_format($other_deposits_total,2); ?>
            </td>
            <td class="list">
                <?php $other_deposits_total = $other_deposits->whereBetween('datetime_other_deposit', ['20242024-11-01', '20242024-11-30'])->sum('rmb_other_deposit'); ?>
                <?php echo number_format($other_deposits_total,2); ?>
            </td>
            <td class="list">
                <?php $other_deposits_total = $other_deposits->whereBetween('datetime_other_deposit', ['20242024-12-01', '20242024-12-31'])->sum('rmb_other_deposit'); ?>
                <?php echo number_format($other_deposits_total,2); ?>
            </td>
            <td class="list">
                <?php $other_deposits_total_all = 
        ...
        <tr>
            ...
            <td class="list">
                <?php $material_credits_total = $material_credits->whereBetween('datetime_material_credit', ['2024202420242024-01-01', '2024202420242024-01-31'])->sum('rmb_material_credit'); ?>
                <?php echo number_format($material_credits_total,2); ?>
            </td>
            <td class="list">
                <?php $material_credits_total = $material_credits->whereBetween('datetime_material_credit', ['2024202420242024-02-01', '2024202420242024-02-29'])->sum('rmb_material_credit'); ?>
                <?php echo number_format($material_credits_total,2); ?>
            </td>
            <td class="list">
                <?php $material_credits_total = $material_credits->whereBetween('datetime_material_credit', ['2024202420242024-03-01', '2024202420242024-03-31'])->sum('rmb_material_credit'); ?>
                <?php echo number_format($material_credits_total,2); ?>
            </td>
            <td class="list">
                <?php $material_credits_total = $material_credits->whereBetween('datetime_material_credit', ['2024202420242024-04-01', '2024202420242024-04-30'])->sum('rmb_material_credit'); ?>
                <?php echo number_format($material_credits_total,2); ?>
            </td>
            <td class="list">
                <?php $material_credits_total = $material_credits->whereBetween('datetime_material_credit', ['2024202420242024-05-01', '2024202420242024-05-31'])->sum('rmb_material_credit'); ?>
                <?php echo number_format($material_credits_total,2); ?>
            </td>
            <td class="list">
                <?php $material_credits_total = $material_credits->whereBetween('datetime_material_credit', ['202420242024-06-01', '202420242024-06-30'])->sum('rmb_material_credit'); ?>
                <?php echo number_format($material_credits_total,2); ?>
            </td>
            <td class="list">
                <?php $material_credits_total = $material_credits->whereBetween('datetime_material_credit', ['202420242024-07-01', '202420242024-07-31'])->sum('rmb_material_credit'); ?>
                <?php echo number_format($material_credits_total,2); ?>
            </td>
            <td class="list">
                <?php $material_credits_total = $material_credits->whereBetween('datetime_material_credit', ['202420242024-08-01', '202420242024-08-31'])->sum('rmb_material_credit'); ?>
                <?php echo number_format($material_credits_total,2); ?>
            </td>
            <td class="list">
                <?php $material_credits_total = $material_credits->whereBetween('datetime_material_credit', ['202420242024-09-01', '202420242024-09-30'])->sum('rmb_material_credit'); ?>
                <?php echo number_format($material_credits_total,2); ?>
            </td>
            <td class="list">
                <?php $material_credits_total = $material_credits->whereBetween('datetime_material_credit', ['202420242024-10-01', '202420242024-10-31'])->sum('rmb_material_credit'); ?>
                <?php echo number_format($material_credits_total,2); ?>
            </td>
            <td class="list">
                <?php $material_credits_total = $material_credits->whereBetween('datetime_material_credit', ['20242024-11-01', '20242024-11-30'])->sum('rmb_material_credit'); ?>
                <?php echo number_format($material_credits_total,2); ?>
            </td>
            <td class="list">
                <?php $material_credits_total = $material_credits->whereBetween('datetime_material_credit', ['20242024-12-01', '20242024-12-31'])->sum('rmb_material_credit'); ?>
                <?php echo number_format($material_credits_total,2); ?>
            </td>
            <td class="list">
                <?php $material_credits_total_all = 
        ...
        <tr>
            ...
            <td class="list-twin">
                <?php $w12 = $details->whereBetween('datetime', ['202420242024-12-01', '202420242024-12-31'])->sum('rmb') 
                + $other_country_deposits->whereBetween('datetime_other_country_deposit', ['202420242024-12-01', '202420242024-12-31'])->sum('rmb_other_country_deposit') 
                + $within_china_deposits->whereBetween('datetime_within_china_deposit', ['202420242024-12-01', '202420242024-12-31'])->sum('rmb_within_china_deposit') 
                // + $no_receipt_deposits->whereBetween('datetime_no_receipt_deposit', ['202420242024-12-01', '202420242024-12-31'])->sum('rmb_no_receipt_deposit') 
                + $hongkong_deposits->whereBetween('datetime_hongkong_deposit', ['202420242024-12-01', '202420242024-12-31'])->sum('rmb_hongkong_deposit')
                + $outsourcing_deposits->whereBetween('datetime_outsourcing_deposit', ['202420242024-12-01', '202420242024-12-31'])->sum('rmb_outsourcing_deposit')
                + $other_deposits->whereBetween('datetime_other_deposit', ['202420242024-12-01', '202420242024-12-31'])->sum('rmb_other_deposit')
                // + $no_receipt_other_deposits->whereBetween('datetime_no_receipt_other_deposit', ['202420242024-12-01', '202420242024-12-31'])->sum('rmb_no_receipt_other_deposit')
                - $material_credits->whereBetween('datetime_material_credit', ['202420242024-12-01', '202420242024-12-31'])->sum('rmb_material_credit')
                - $auxiliary_material_credits->whereBetween('datetime_auxiliary_material_credit', ['202420242024-12-01', '202420242024-12-31'])->sum('rmb_auxiliary_material_credit')
                ; ?>
                <?php echo number_format($w12,2); ?>
            </td>
            <td class="list-twin">
        ...
        <tr>
            ...
            <th class="th">保険料支払</th>
            <td class="list">
                <?php $insurances_total = $insurances->whereBetween('datetime_insurance', ['20242024-01-01', '20242024-01-31'])->sum('rmb_insurance'); ?>
                <?php echo number_format($insurances_total,2); ?>
            </td>
            <td class="list">
                <?php $insurances_total = $insurances->whereBetween('datetime_insurance', ['20242024-02-01', '20242024-02-29'])->sum('rmb_insurance'); ?>
                <?php echo number_format($insurances_total,2); ?>
            </td>
            <td class="list">
                <?php $insurances_total = $insurances->whereBetween('datetime_insurance', ['20242024-03-01', '20242024-03-31'])->sum('rmb_insurance'); ?>
                <?php echo number_format($insurances_total,2); ?>
            </td>
            <td class="list">
                <?php $insurances_total = $insurances->whereBetween('datetime_insurance', ['20242024-04-01', '20242024-04-30'])->sum('rmb_insurance'); ?>
                <?php echo number_format($insurances_total,2); ?>
            </td>
            <td class="list">
                <?php $insurances_total = $insurances->whereBetween('datetime_insurance', ['20242024-05-01', '20242024-05-31'])->sum('rmb_insurance'); ?>
                <?php echo number_format($insurances_total,2); ?>
            </td>
            <td class="list">
            ...
            <td class="list">
                <?php $insurances_total_all = 
                $insurances->whereBetween('datetime_insurance', ['2024202420242024-01-01', '2024202420242024-01-31'])->sum('rmb_insurance')
                + $insurances->whereBetween('datetime_insurance', ['2024202420242024-02-01', '2024202420242024-02-29'])->sum('rmb_insurance')
                + $insurances->whereBetween('datetime_insurance', ['2024202420242024-03-01', '2024202420242024-03-31'])->sum('rmb_insurance')
                + $insurances->whereBetween('datetime_insurance', ['2024202420242024-04-01', '2024202420242024-04-30'])->sum('rmb_insurance')
                + $insurances->whereBetween('datetime_insurance', ['2024202420242024-05-01', '2024202420242024-05-31'])->sum('rmb_insurance')
                + $insurances->whereBetween('datetime_insurance', ['2024202420242024-06-01', '2024202420242024-06-30'])->sum('rmb_insurance')
                + $insurances->whereBetween('datetime_insurance', ['2024202420242024-07-01', '2024202420242024-07-31'])->sum('rmb_insurance')
                + $insurances->whereBetween('datetime_insurance', ['2024202420242024-08-01', '2024202420242024-08-31'])->sum('rmb_insurance')
                + $insurances->whereBetween('datetime_insurance', ['2024202420242024-09-01', '2024202420242024-09-30'])->sum('rmb_insurance')
                + $insurances->whereBetween('datetime_insurance', ['2024202420242024-10-01', '2024202420242024-10-31'])->sum('rmb_insurance')
                + $insurances->whereBetween('datetime_insurance', ['2024202420242024-11-01', '2024202420242024-11-30'])->sum('rmb_insurance')
                + $insurances->whereBetween('datetime_insurance', ['2024202420242024-12-01', '2024202420242024-12-31'])->sum('rmb_insurance')
                ;?>
                <?php echo number_format($insurances_total_all,2) ; ?>
            </td>
            <td class="list">
        ...
        <tr>
            ...
            <th class="th">チケット費用支払</th>
            <td class="list">
                <?php $ticket_fees_total = $ticket_fees->whereBetween('datetime_ticket_fee', ['202420242024-01-01', '202420242024-01-31'])->sum('rmb_ticket_fee'); ?>
                <?php echo number_format($ticket_fees_total,2); ?>
            </td>
            <td class="list">
                <?php $ticket_fees_total = $ticket_fees->whereBetween('datetime_ticket_fee', ['202420242024-02-01', '202420242024-02-29'])->sum('rmb_ticket_fee'); ?>
                <?php echo number_format($ticket_fees_total,2); ?>
            </td>
            <td class="list">
                <?php $ticket_fees_total = $insurances->whereBetween('datetime_ticket_fee', ['202420242024-03-01', '202420242024-03-31'])->sum('rmb_ticket_fee'); ?>
                <?php echo number_format($ticket_fees_total,2); ?>
            </td>
            <td class="list">
                <?php $ticket_fees_total = $ticket_fees->whereBetween('datetime_ticket_fee', ['202420242024-04-01', '202420242024-04-30'])->sum('rmb_ticket_fee'); ?>
                <?php echo number_format($ticket_fees_total,2); ?>
            </td>
            <td class="list">
                <?php $ticket_fees_total = $ticket_fees->whereBetween('datetime_ticket_fee', ['202420242024-05-01', '202420242024-05-31'])->sum('rmb_ticket_fee'); ?>
                <?php echo number_format($ticket_fees_total,2); ?>
            </td>
            <td class="list">
                <?php $ticket_fees_total = $ticket_fees->whereBetween('datetime_ticket_fee', ['20242024-06-01', '20242024-06-30'])->sum('rmb_ticket_fee'); ?>
                <?php echo number_format($ticket_fees_total,2); ?>
            </td>
            <td class="list">
                <?php $ticket_fees_total = $ticket_fees->whereBetween('datetime_ticket_fee', ['20242024-07-01', '20242024-07-31'])->sum('rmb_ticket_fee'); ?>
                <?php echo number_format($ticket_fees_total,2); ?>
            </td>
            <td class="list">
                <?php $ticket_fees_total = $ticket_fees->whereBetween('datetime_ticket_fee', ['20242024-08-01', '20242024-08-31'])->sum('rmb_ticket_fee'); ?>
                <?php echo number_format($ticket_fees_total,2); ?>
            </td>
            <td class="list">
                <?php $ticket_fees_total = $ticket_fees->whereBetween('datetime_ticket_fee', ['20242024-09-01', '20242024-09-30'])->sum('rmb_ticket_fee'); ?>
                <?php echo number_format($ticket_fees_total,2); ?>
            </td>
            <td class="list">
                <?php $ticket_fees_total = $ticket_fees->whereBetween('datetime_ticket_fee', ['20242024-10-01', '20242024-10-31'])->sum('rmb_ticket_fee'); ?>
                <?php echo number_format($ticket_fees_total,2); ?>
            </td>
            <td class="list">
        ...
        <tr>
            ...
            <td class="list">
                <?php $travel_expenses_total = $travel_expenses->whereBetween('datetime_travel_expense', ['20242024-05-01', '20242024-05-31'])->sum('rmb_travel_expense'); ?>
                <?php echo number_format($travel_expenses_total,2); ?>
            </td>
            <td class="list">
                <?php $travel_expenses_total = $travel_expenses->whereBetween('datetime_travel_expense', ['20242024-06-01', '20242024-06-30'])->sum('rmb_travel_expense'); ?>
                <?php echo number_format($travel_expenses_total,2); ?>
            </td>
            <td class="list">
                <?php $travel_expenses_total = $travel_expenses->whereBetween('datetime_travel_expense', ['20242024-07-01', '20242024-07-31'])->sum('rmb_travel_expense'); ?>
                <?php echo number_format($travel_expenses_total,2); ?>
            </td>
            <td class="list">
                <?php $travel_expenses_total = $travel_expenses->whereBetween('datetime_travel_expense', ['20242024-08-01', '20242024-08-31'])->sum('rmb_travel_expense'); ?>
                <?php echo number_format($travel_expenses_total,2); ?>
            </td>
            <td class="list">
        ...
        <tr>
            ...
            <td class="list">
                <?php $utility_costs_total = $utility_costs->whereBetween('datetime_utility_cost', ['202420242024-05-01', '202420242024-05-31'])->sum('rmb_utility_cost'); ?>
                <?php echo number_format($utility_costs_total,2); ?>
            </td>
            <td class="list">
                <?php $utility_costs_total = $utility_costs->whereBetween('datetime_utility_cost', ['202420242024-06-01', '202420242024-06-30'])->sum('rmb_utility_cost'); ?>
                <?php echo number_format($utility_costs_total,2); ?>
            </td>
            <td class="list">
                <?php $utility_costs_total = $utility_costs->whereBetween('datetime_utility_cost', ['202420242024-07-01', '202420242024-07-31'])->sum('rmb_utility_cost'); ?>
                <?php echo number_format($utility_costs_total,2); ?>
            </td>
            <td class="list">
                <?php $utility_costs_total = $utility_costs->whereBetween('datetime_utility_cost', ['202420242024-08-01', '202420242024-08-31'])->sum('rmb_utility_cost'); ?>
                <?php echo number_format($utility_costs_total,2); ?>
            </td>
            <td class="list">
                <?php $utility_costs_total = $utility_costs->whereBetween('datetime_utility_cost', ['202420242024-09-01', '202420242024-09-30'])->sum('rmb_utility_cost'); ?>
                <?php echo number_format($utility_costs_total,2); ?>
            </td>
            <td class="list">
                <?php $utility_costs_total = $utility_costs->whereBetween('datetime_utility_cost', ['20242024-10-01', '20242024-10-31'])->sum('rmb_utility_cost'); ?>
                <?php echo number_format($utility_costs_total,2); ?>
            </td>
            <td class="list">
                <?php $utility_costs_total = $utility_costs->whereBetween('datetime_utility_cost', ['20242024-11-01', '20242024-11-30'])->sum('rmb_utility_cost'); ?>
                <?php echo number_format($utility_costs_total,2); ?>
            </td>
            <td class="list">
                <?php $utility_costs_total = $utility_costs->whereBetween('datetime_utility_cost', ['20242024-12-01', '20242024-12-31'])->sum('rmb_utility_cost'); ?>
                <?php echo number_format($utility_costs_total,2); ?>
            </td>
            <td class="list">
                <?php $utility_costs_total_all = 
