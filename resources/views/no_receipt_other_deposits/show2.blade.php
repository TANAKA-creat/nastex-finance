  ...
  @section('content')
      <div class="container">
          <div class="row">
              ...
              <h1>領収書なしその他入金 - 詳細</h1>
              <div class="back-link">
                  <a href="{{ route('no_receipt_other_deposits.show') }}">&laquo; 時間指定に移動</a>
              ...
              <div class="col-md-6">
                  <div class="test">
                      <form action="{{ route('no_receipt_other_deposits.name') }}" method="POST">
                          @csrf
                          <div class="form-group">
                              <input type="text" name="no_receipt_other_deposit_customer" placeholder="顧客名">
                  ...
                  <table border="2" class="table" style="solid 2px";>
                      <thead>
                          <tr>
                            <th>@sortablelink('datetime_no_receipt_other_deposit','記録日')</th>
                            <th>@sortablelink('no_receipt_other_deposit_customer','入金項目')</th>
                            <th>@sortablelink('rmb_no_receipt_other_deposit','金額（RMB）')</th>
                              <th>金額（USD）</th>
                              <th>編集</th>
                              <th>削除</th>
                          </tr>
