  ...
  @section('content')
      <div class="container">
          <div class="row">
              ...
              <h1>日本本社入金 - 詳細</h1>
              <div class="back-link">
                  <a href="{{ route('details.show') }}">&laquo; 時間指定に移動</a>
              ...
              <div class="col-md-6">
                  <div class="test">
                      <form action="{{ route('details.name') }}" method="POST">
                          @csrf
                          <div class="form-group">
                              <input type="text" name="customer" placeholder="顧客名">
                      ...
                      <tbody>
                          @foreach ($details as $detail)
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <form method="POST"
                                          action="{{ route('details.destroy', $detail->id) }}"
                                          id="delete">
                                          @method('DELETE')
                                          @csrf
                                          <button>削除</button>
